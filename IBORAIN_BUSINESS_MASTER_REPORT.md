...
├───────────────────────────────┬────────────────────────────────┬─────────────────────────────────┤
│ 🟢 Package A: Solar Sentry    │ 🟣 Package B: Corridor Node    │ 💻 Package C: Smart CCTV Cloud  │
│    (Estate Gates & Perimeters)│    (Highways & SACCO Stages)   │    (Hospitals & Existing CCTVs) │
├───────────────────────────────┼────────────────────────────────┼─────────────────────────────────┤
│ • Hardware: Universal Solar   │ • Hardware: Solar + Night IR   │ • Hardware: $0 (Pure Software!) │
│ • Subscription: $49/mo (6.5k) │ • Subscription: $99/mo (12.8k) │ • Subscription: $20/camera/mo   │
│ • BOM Cost: $142.00 USD       │ • BOM Cost: $202.50 USD        │ • BOM Cost: $0.00 USD           │
│ • Net Payback: 58 Days ⚡     │ • Net Payback: 29–67 Days ⚡   │ • Net Margin: 91.0% Pure Profit!│
└───────────────────────────────┴────────────────────────────────┴─────────────────────────────────┘
```

---

### 🟢 PACKAGE A: Iborain Universal Solar Sentry (Estate Gate & Perimeter Node)
*Target: Residential Estate Barriers, School Gates, Transport Yards (100% Blackout-Proof Solar).*
...
| **PETG Universal Enclosure** | Dual-Mount Capsule (Pole Saddle R=45mm + Wall Grid) | $4.50 | KES 585 |
| **15W Monocrystalline Panel**| Weatherproof Solar Canopy with Mast Bracket | $12.00 | KES 1,560 |
| **Bestfire 1350mAh Battery** | Type-C USB Rechargeable Li-ion Buffer Pack | $4.50 | KES 585 |
| **TOTAL PACKAGE A BOM** | **Complete Universal Autonomous Solar Sentry** | **$142.00** | **KES 18,460** |
...
\mathbf{\text{Capital Payback Period}} &= \frac{\text{KES } 18,460 - \text{KES } 3,500}{\text{KES } 5,800 \text{/mo}} = \mathbf{2.58 \text{ Months (77 Days!)}}
\end{aligned}$$
